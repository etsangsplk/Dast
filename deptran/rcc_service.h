...
class ClassicServiceImpl : public ClassicService {
 ...
 public:
  ...
  void ChronosSubmitDistributed(const std::map<parid_t, std::vector<SimpleCommand>> &cmds_by_par,
                                const ChronosSubmitReq &req,
                                ChronosSubmitRes *chr_res,
                                TxnOutput *output,
                                rrr::DeferredReply *defer) override;
  ...
  void ChronosRemotePrepared(const ChronosRemotePreparedReq &req,
  ...
  void SlogSubmitLocal(const std::vector<SimpleCommand> &cmd,
                       TxnOutput *output,
                       rrr::DeferredReply *defer) override;
