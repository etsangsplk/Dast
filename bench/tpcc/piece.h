...
// ====== Query2 txn ========
#define TPCC_QUERY2                 60
#define TPCC_QUERY2_NAME            "QUERY2"
//piece 0 read and filter nation locally
#define TPCC_QUERY2_0               600 
//piece RSU read and filter supplier locally
#define TPCC_QUERY2_RSU(i)          (61000+i)
//piece read and filter stock
#define TPCC_QUERY2_RS(i)           (62000+i)
//piece update stock with min quantity
#define TPCC_QUERY2_WS(i)           (63000+i)
...
#define TPCC_COL_REGION_R_REGIONKEY            (0)
#define TPCC_COL_REGION_R_W_ID                 (1)
#define TPCC_COL_REGION_R_NAME                 (2)
#define TPCC_COL_REGION_R_COMMENT              (3)

#define TPCC_COL_NATION_N_NATION_KEY           (0)
#define TPCC_COL_NATION_N_N_W_ID               (1)
#define TPCC_COL_NATION_N_REGIONKEY            (2)
#define TPCC_COL_NATION_N_COMMENT              (3)

#define TPCC_COL_SUPPLIER_S_SUPPLIERKEY        (0)
#define TPCC_COL_SUPPLIER_S_W_ID               (1)
#define TPCC_COL_SUPPLIER_S_NATIONKEY          (2)
#define TPCC_COL_SUPPLIER_S_NAME               (3)
#define TPCC_COL_SUPPLIER_S_ADDRESS            (4)
#define TPCC_COL_SUPPLIER_S_PHONE              (5)
#define TPCC_COL_SUPPLIER_S_ACCTBAL            (6)
#define TPCC_COL_SUPPLIER_S_COMMENT            (7)
#define TPCC_COL_SUPPLIER_S_MIN_WAREHOUSE      (8)
#define TPCC_COL_SUPPLIER_S_MIN_ITEM           (9)
#define TPCC_COL_SUPPLIER_S_MIN_QUAN           (10)

#define TPCC_VAR_W_ID                          (1001)
#define TPCC_VAR_R_ID                          (1096)
...
#define TPCC_VAR_N_KEY(I)                      (600000 + I)
#define TPCC_VAR_SU_KEY(I)                     (610000 + I)
#define TPCC_VAR_RS_W_ID(I)                    (620000 + I)
#define TPCC_VAR_MIN_ITEM(I)                   (630000 + I)
#define TPCC_VAR_MIN_QUAN(I)                   (640000 + I)
#define TPCC_VAR_OUT_NATION_KEY(I)             (650000 + I)
#define TPCC_VAR_NUM_N_ID                      (660000)
#define TPCC_VAR_NUM_W_ID                      (670000)
#define TPCC_VAR_NUM_I_ID                      (680000)
//
...
extern char TPCC_TB_REGION[];
extern char TPCC_TB_NATION[];
extern char TPCC_TB_SUPPLIER[];
